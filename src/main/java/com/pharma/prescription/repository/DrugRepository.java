...
public interface DrugRepository extends JpaRepository<Drug, Long> {
   ...
   *
   * @param date The date to compare against the expiry date. Typically, this would be the current
   *     date.
  ...
  /**
   * Finds a drug by its name and manufacturer and batch number. This can be useful to uniquely
   * identify a specific batch of a drug.
   *
   ...
   */
  Optional<Drug> findByNameAndManufacturerAndBatchNumber(
      String name, String manufacturer, String batchNumber);
